...
@section('title', 'Add Dating Question')

@section('content')
<div class="max-w-4xl mx-auto py-10" x-data="{ 
    type: 'character', 
    options: [{ emoji: '❓', label: 'Option Title', traits: { Spontaneous: 0, Homebody: 0, Adventurous: 0, Romantic: 0, Logical: 0, Organized: 0, Social: 0, Creative: 0 } }],
    addOption() { 
    ...
    <div class="flex justify-between items-center mb-10">
        <h1 class="text-3xl font-black text-gray-900 tracking-tight">Add New Question</h1>
        <a href="{{ route('admin.dating-questions.index') }}" class="text-sm font-bold text-gray-500 hover:text-gray-900 transition underline">Back to List</a>
    </div>

    <form action="{{ route('admin.dating-questions.store') }}" method="POST" class="space-y-8">
        @csrf
        ...
        <div class="bg-white shadow-2xl rounded-3xl overflow-hidden border border-gray-100">
            <div class="p-8 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div>
                        ...
                        <select name="universe" class="w-full rounded-2xl border-gray-100 bg-gray-50 py-4 px-6 text-gray-700 font-bold focus:ring-pink-500 focus:border-pink-500 transition">
                            ...
                            <option value="Phineas & Ferb">Phineas & Ferb</option>
                ...
                <div>
                  ...
                  <input type="text" name="text" placeholder="e.g. Harry Potter: Der sprechende Hut?" class="w-full rounded-2xl border-gray-100 bg-gray-50 py-4 px-6 text-gray-700 font-bold focus:ring-pink-500 focus:border-pink-500 transition" required>
                </div>
            </div>
