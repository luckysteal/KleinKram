...
@section('content')
    <h1 class="text-2xl font-bold text-gray-800 mb-4">Create New Drink</h1>
    ...
    <form action="{{ route('admin.drinks.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="number" step="0.01" name="price" id="price" class="w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
        </div>

        <div class="mb-4">
            <label for="icon_svg" class="block font-medium text-sm text-gray-700">Icon SVG</label>
            <textarea name="icon_svg" id="icon_svg" rows="5" class="w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm"></textarea>
        </div>
